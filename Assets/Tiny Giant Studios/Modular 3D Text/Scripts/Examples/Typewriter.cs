    ...
    public class Typewriter : MonoBehaviour
    {
        ...
        IEnumerator TypingRoutine()
        {
            ...
            if (modular3DText)
            {
                ...
                {
                    modular3DText.UpdateText(text.Substring(0, i) + typingSymbol);
            ...
            {
                Debug.Log("<color=yellow>No text object is selected on typewriter.</color> :" + gameObject.name, gameObject);
            }
        }
    }
}