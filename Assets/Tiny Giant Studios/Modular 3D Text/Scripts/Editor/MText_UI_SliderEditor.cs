...
namespace MText
{
    ...
    public class MText_UI_SliderEditor : Editor
    {
        ...
        void MainSettings()
        {
            ...
            DrawUILine(Color.grey, 1, 2);
            HorizontalField(autoFocusOnGameStart, "Auto Focus", "Selects on game start. Focused items can be controlled by keyboard", FieldSize.small);
            ...
            myTarget.currentValue = EditorGUILayout.Slider(myTarget.currentValue, myTarget.minValue, myTarget.maxValue);
            GUILayout.EndHorizontal();
        ...
        void ApplyModifiedValuesToHandleAndBackground()
        {
            ...
            if (myTarget.handle)
                myTarget.handle.GetHandlePositionFromSlider();
