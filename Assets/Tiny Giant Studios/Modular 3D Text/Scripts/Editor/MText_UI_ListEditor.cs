...
namespace MText
{
    ...
    public class MText_UI_ListEditor : Editor
    {
        ...
        bool showNormalItemVisualSettings = false;
        ...
        void OnEnable()
        {
            ...
            //showKeyboardSettings = myTarget.keyboardControl;
            ...
            //showChildVisualSettings = myTarget.controlChildVisuals;

            customNormalItemVisual = soTarget.FindProperty("customNormalItemVisual");
            //showNormalItemVisualSettings = myTarget.customNormalItemVisual;
            ...
            //showSelectedItemSettings = myTarget.customSelectedItemVisual;
            ...
            //showPressedItemSettings = myTarget.customPressedItemVisual;
            ...
            //showDisabledItemSettings = myTarget.customDisabledItemVisual;
            ...
            //showModuleSettings = myTarget.applyModules;
        ...
        void NormalItemSettings()
        {
            ...
            showNormalItemVisualSettings = EditorGUILayout.Foldout(showNormalItemVisualSettings, "Normal", true, EditorStyles.foldout);
            GUILayout.EndHorizontal();

            if (showNormalItemVisualSettings)
            {
                DrawUILine(Color.grey, 1, 2);
                EditorGUI.indentLevel = 0;
                GUI.backgroundColor = settings.thirdPropertyFieldColor;
