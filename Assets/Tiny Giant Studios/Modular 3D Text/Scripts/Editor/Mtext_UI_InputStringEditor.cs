...
namespace MText
{
    [CustomEditor(typeof(Mtext_UI_InputString))]
    public class Mtext_UI_InputStringEditor : Editor
    {
        ...
        void OnEnable()
        {
            myTarget = (Mtext_UI_InputString)target;
        ...
        void MainSettings()
        {
            ...
            if (showMainSettings)
            {
                ...
                HorizontalField(input, "Input Text");
                HorizontalField(placeHolderText, "Placeholder Text");
                ...
                HorizontalField(text, "3D Text", "Reference to the 3D Text where input will be shown");
